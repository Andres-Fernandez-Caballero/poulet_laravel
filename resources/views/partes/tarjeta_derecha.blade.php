<article class="m-2 my-4 row">
    <div class="col-lg-8">
        ...
        <p><i class="pink-text fa fa-clock-o" aria-hidden="true"></i> <span>{{$receta->tiempo_preparacion}}</span> min</p>
        <p><i class="pink-text fa fa-heart" aria-hidden="true"></i> <span>{{$receta->dificultad}}</span></p>
